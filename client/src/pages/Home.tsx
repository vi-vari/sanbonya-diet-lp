      ...
      <div className="max-w-[700px] mx-auto">
        ...
        <section className="border-t border-neutral-200 px-4 py-6">
          <div className="flex flex-col gap-10">
            <div className="overflow-hidden">
              <img src="/16-19.webp" alt="ビフォーアフター実績1" className="w-full h-auto" />
            </div>
            <div className="overflow-hidden">
              <img src="/16-21.webp" alt="ビフォーアフター実績2" className="w-full h-auto" />
            </div>
            <div className="overflow-hidden">
              <img src="/16-23.webp" alt="ビフォーアフター実績3" className="w-full h-auto" />
            </div>
            <div className="overflow-hidden">
              <img src="/16-25.webp" alt="ビフォーアフター実績4" className="w-full h-auto" />
            </div>
            <div className="overflow-hidden">
              <img src="/16-27.webp" alt="ビフォーアフター実績5" className="w-full h-auto" />
            </div>
            <div className="overflow-hidden">
              <img src="/16-29.webp" alt="ビフォーアフター実績6" className="w-full h-auto" />
            </div>
            <div className="overflow-hidden">
              <img src="/16-31.webp" alt="ビフォーアフター実績7" className="w-full h-auto" />
            </div>
          </div>
        </section>
        ...
        <section className="border-t border-neutral-200 px-4 py-6">
          <div className="grid grid-cols-4 gap-1">
            <div className="overflow-hidden aspect-square">
              <img src="/91-11.webp" alt="口コミ1" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden aspect-square">
              <img src="/91-6.webp" alt="口コミ2" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden aspect-square">
              <img src="/91-3.webp" alt="口コミ3" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden aspect-square">
              <img src="/91-9.webp" alt="口コミ4" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden aspect-square">
              <img src="/91-8.webp" alt="口コミ5" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden aspect-square">
              <img src="/91-2.webp" alt="口コミ6" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden aspect-square">
              <img src="/16-53.webp" alt="口コミ7" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden aspect-square">
              <img src="/91-5.webp" alt="口コミ8" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden aspect-square">
              <img src="/91-10.webp" alt="口コミ9" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden aspect-square">
              <img src="/91-4.webp" alt="口コミ10" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden aspect-square">
              <img src="/109-2.webp" alt="口コミ11" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden aspect-square">
              <img src="/91-13.webp" alt="口コミ12" className="w-full h-full object-cover" />
            </div>
          </div>
        </section>
        ...
        <section className="border-t border-neutral-200 px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <img src="/16-105.webp" alt="個室のプライベート空間" className="w-full h-auto rounded mb-3" />
          ...
          <div className="mb-8">
            ...
            <img src="/16-109.webp" alt="個別プラン提案" className="w-full h-auto rounded mb-3" />
            <p className="text-[#736357] text-base">
          ...
          <div className="mb-8">
            ...
            <img src="/16-113.webp" alt="全身美容整体" className="w-full h-auto rounded mb-3" />
            <p className="text-[#736357] text-base">
        ...
        <section className="border-t border-neutral-200 px-4 py-8">
          ...
          <img src="/16-181.webp" alt="東広島西条整骨院 外観" className="w-full h-auto rounded mb-4" />
        ...
        <section className="border-t border-neutral-200 px-4 py-8">
          ...
          <div className="border-2 border-neutral-200 rounded p-4 mb-6">
            ...
            <div className="flex justify-center mb-4">
              <img src="/16-251.webp" alt="太った理由を徹底分析" className="w-full max-w-[400px] h-auto rounded" />
            </div>
            <p className="text-[#736357] text-base">
          ...
          <div className="border-2 border-neutral-200 rounded p-4 mb-6">
            ...
            <div className="flex justify-center mb-4">
              <img src="/16-256.webp" alt="痩身整体" className="w-full max-w-[400px] h-auto rounded" />
            </div>
            <p className="text-[#736357] text-base">
          ...
          <div className="border-2 border-neutral-200 rounded p-4 mb-6">
            ...
            <div className="flex justify-center mb-4">
              <img src="/16-261.webp" alt="マンツーマン食事サポート" className="w-full max-w-[400px] h-auto rounded" />
            </div>
            <p className="text-[#736357] text-base">
